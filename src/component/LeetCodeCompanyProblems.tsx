...
// Define the structure of our LeetCode problem data
...
const problemsData: LeetCodeProblem[] = [
  {
    "Difficulty": "EASY",
...
const LeetCodeCompanyProblems: React.FC = () => {
  ...
  {sortedProblems.map((problem, index) => (
    <TableRow key={index}>
      ...
      <TableCell className="text-right py-4">{problem.Frequency.toFixed(1)}</TableCell>
      <TableCell className="text-right py-4">{(problem['Acceptance Rate'] * 100).toFixed(1)}%</TableCell>
    ...
    <TableRow>
      <TableCell colSpan={5} className="text-center py-6">
        ...
        <div className="mt-4 text-sm text-gray-500">
          Showing {sortedProblems.length} of {problemsData.length} problems
        </div>
      </CardContent>
    </Card>
  );
